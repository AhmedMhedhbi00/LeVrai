...
<head>
    ...
    <title>Registrati | LeVrai Streetwear</title>
...
<body>
    ...
    <div class="auth-left">
        ...
        <div class="left-headline">
            <h2>ENTRA<br>NEL<br>CREW.</h2>
            <p>Registrati e accedi a drop esclusivi, offerte riservate e molto altro.</p>
        </div>
    ...
    <div class="auth-right">
        <div class="form-header">
            <h1>CREA ACCOUNT.</h1>
            <p>Unisciti alla community LeVrai</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="firstname" placeholder="Il tuo nome" value="{{ old('firstname') }}"
                            required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <i class="fas fa-user icon-left"></i>
                        <input type="text" name="lastname" placeholder="Il tuo cognome" value="{{ old('lastname') }}"
                            required>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="text" name="username" placeholder="Scegli uno username" value="{{ old('username') }}"
                        required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="email" name="email" placeholder="La tua email" value="{{ old('email') }}" required>
                </div>
            </div>
            ...
            <button type="submit" class="btn-primary">
                REGISTRATI <i class="fas fa-arrow-right"></i>
            </button>
        </form>

        <div class="divider">oppure registrati con</div>
        ...
        <div class="form-footer">
            Hai già un account? <a href="{{ route('login') }}">Accedi ora →</a>
        </div>
    </div>
    ...
    document.querySelector('form').addEventListener('submit', function(e) {
        ...
        const confirm = this.querySelector('[name="password_confirmation"]').value.trim();
        ...
        if (username.length < 3) {
            e.preventDefault();
            alert('Username troppo corto (min 3 caratteri).');
            return;
        }
        if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email)) {
            e.preventDefault();
